...
?>
<!-- BEGIN .hentry -->
<article id="post-<?php the_ID(); ?>" <?php if ( !empty($gallery_images) ) post_class('with-featured-image slider-post-type ' . $blog_grid_column_class ); else post_class('slider-post-type ' . $blog_grid_column_class ); ?> itemscope itemtype="http://schema.org/BlogPosting">
