...
function vw_hospital_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section('vw_hospital_lite_footer-section',array(
        'title' => __('Address','vw-hospital-lite'),
        'description'   => __('This section is used to display address in footer and contact page template','vw-hospital-lite'),
        'panel' => 'vw_hospital_lite_panel_id',
    ));

    $wp_customize->add_setting('vw_hospital_lite_contact_info_footer',array(
        'default'   => '',
        'sanitize_callback' => 'sanitize_text_field',
    ));
    
    $wp_customize->add_control('vw_hospital_lite_contact_info_footer',array(
            'label' => __('Address Title','vw-hospital-lite'),
            'section' => 'vw_hospital_lite_footer-section',
            'setting'   => 'vw_hospital_lite_contact_info_footer',
            'type'  => 'text'
        )
    );
    $wp_customize->add_setting('vw_hospital_lite_contact_add',array(
        'default'   => '',
        'sanitize_callback' => 'wp_kses_post',
    	)
    );    
    $wp_customize->add_control('vw_hospital_lite_contact_add',array(
            'label' => __('Our Address','vw-hospital-lite'),
            'section' => 'vw_hospital_lite_footer-section',
            'setting'   => 'vw_hospital_lite_contact_add',
            'type'  => 'textarea'
        )
    );
